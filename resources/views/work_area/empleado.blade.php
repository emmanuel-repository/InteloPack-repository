    ...
    <div class="card-header">
        <div class="row">
            ...
            <div class="col-md-6 d-flex justify-content-end">
                <a type="button" class="btn btn-sm btn-success text-white" id="btn_open_modal_empleado" data-toggle='tooltip' data-placement='right' title='Agregar Empleado'>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-striped rounded table-sm" 
                id="data_table_empleados" width="100%" cellspacing="0">
                ...
                <div class="modal-body">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="password" class="form-control" id="password_empleado" name="password_empleado" 
...
<div class="modal fade" id="modal_editar_empleado" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form_validate_empleado_editar">
                ...
                <div class="modal-body">
                    <div class="form-row">
                    <input type="text" class="form-control d-none" id="id_empleado_editar" name="id_empleado_editar">
                        <div class="form-group col-md-6">
                            <label for="recipient-name" class="col-form-label">Nombre*</label>
                            <input type="text" class="form-control" id="nombre_empleado_editar" name="nombre_empleado_editar" maxlength="50" onKeyUp="document.getElementById(this.id).value = document.getElementById(this.id).value.toUpperCase()">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="recipient-name" class="col-form-label">Primer Apellido*</label>
                            <input type="text" class="form-control" id="apellido1_empleado_editar" name="apellido1_empleado_editar" maxlength="50" onKeyUp="document.getElementById(this.id).value = document.getElementById(this.id).value.toUpperCase()">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="recipient-name" class="col-form-label">Segundo Apellido*</label>
                            <input type="text" class="form-control" id="apellido2_empleado_editar" name="apellido2_empleado_editar" maxlength="50" onKeyUp="document.getElementById(this.id).value = document.getElementById(this.id).value.toUpperCase()">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="recipient-name" class="col-form-label">Correo*</label>
                            <input type="email" class="form-control" id="email_empleado_editar" name="email_empleado_editar" maxlength="50">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="recipient-name" class="col-form-label">Contraseña</label>
                            <input type="password" class="form-control" id="password_empleado_editar" name="password_empleado_editar"
                                maxlength="20">
                        </div>
                        {{-- <div class="form-group col-md-6">
                            <label for="recipient-name" class="col-form-label">Contraseña</label>
